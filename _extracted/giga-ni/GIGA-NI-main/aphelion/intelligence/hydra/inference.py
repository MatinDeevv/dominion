...
class HydraInference:
    ...
    def load_checkpoint(self, path: str) -> None:
        ...
        self._model.eval()
        logger.info("hydra_ensemble_loaded", checkpoint_path=path, device=str(self._device))

    def _encode_cat(self, name: str, value: object) -> int:
    ...
    def process_bar(self, features: dict[str, object]) -> Optional[HydraSignal]:
    ...
    def _format_batch_outputs(
        self, outputs: dict[str, "torch.Tensor"], timestamps: Optional[list[int]] = None
    ) -> list[HydraSignal]:
        signals = []
