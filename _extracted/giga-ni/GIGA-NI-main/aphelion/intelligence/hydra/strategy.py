...
class HydraStrategy:
    ...
    def __call__(
        ...
        # ATR is under the canonical key "technical_atr_14"; fall back to the
        # flat "atr" key for any legacy feature dict and then to a percentage
        # of price if neither key is present or both are None.
        atr = features.get("technical_atr_14")
        if atr is None:
