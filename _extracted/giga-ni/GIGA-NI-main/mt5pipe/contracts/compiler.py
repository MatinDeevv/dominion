"""Shared compiler-era contracts consumed across sectors.

These models define the canonical artifact/spec surface for dataset builds,
training runs, and lineage metadata. They live in ``mt5pipe.contracts`` so
state/features/compiler sectors can share them without importing compiler
internals.
"""
...
class ExperimentSpec(BaseModel):
    """Training/evaluation spec for trusted dataset artifacts."""
