...
Usage:
    python scripts/dev_tools/sxcas.py
    python scripts/dev_tools/sxcas.py --filter mt5
    python scripts/dev_tools/sxcas.py --csv processes.csv
    python scripts/dev_tools/sxcas.py --all
