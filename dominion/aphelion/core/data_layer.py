...
class DataLayer:
    ...
    def ingest_completed_bar(self, bar: Bar, *, publish_event: bool = False) -> bool:
        """Append a completed bar through the public data-layer API."""
        bar_valid, _ = self._validator.validate_bar(bar)
        if not bar_valid:
            return False
