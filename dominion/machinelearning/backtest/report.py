"""Reporting helpers for the canonical machinelearning backtest layer."""
...
class BacktestReport:
    """Summarize vectorized backtest output in trader-readable form."""
    ...
    def from_result(cls, result: BacktestResult) -> "BacktestReport":
        ...
        regime_breakdown = {
            ...
            for name in tuple(DEFAULT_REGIME_ORDER)
            + tuple(name for name in counts if name not in DEFAULT_REGIME_ORDER)
        }
        ...
        payload.update(
            {
                ...
                "action_horizon_minutes": self.metrics.action_horizon_minutes,
