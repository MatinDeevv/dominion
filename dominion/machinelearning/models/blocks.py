...
class VariableSelectionNetwork(nn.Module):
    ...
    def forward(self, inputs: Tensor, context: Tensor | None = None) -> tuple[Tensor, Tensor]:
        ...
        if self.weight_grn is None:
            raise RuntimeError("VariableSelectionNetwork weight_grn is unavailable for a positive feature count.")
...
AttentionBlock = TemporalSelfAttention
